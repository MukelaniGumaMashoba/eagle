  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to EagleEye!</h1>
